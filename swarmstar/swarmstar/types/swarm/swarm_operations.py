...
from swarmstar.utils.misc.ids import generate_uuid, get_available_id
...
class SwarmOperation(BaseModel, ABC):
    ...
    @staticmethod
    def update(operation: SwarmOperation) -> None:
        db.update("swarm_operations", operation.id, operation.model_dump())
