...
class SequentialPlanInstructor(BaseInstructor):
    steps: List[str] = Field(
        ...,
        description="Break the goal into actionable steps that must be executed in sequence.",
    )
    ...
    def write_instructions(
        ...
        return [
            Message(
                ...
                content=f"The goal is: {goal}. Please break it down into sequential steps."
