...
from swarmstar.actions.specific.route.base_route_metadata_tree import BaseRouteMetadataTree
...
class RouteAction(BaseRouteMetadataTree):
    ...
    system_prompt = "Given the goal or task, decide what would be the best path of action to take."
