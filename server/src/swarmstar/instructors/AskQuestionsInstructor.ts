...
const QuestionInstructorSchema = z.object({
  questions: z
    .array(z.string())
    .describe('It seems like we need more information to do this. Ask questions to get more information.'),
    ...
    return [
      {
        ...
        content:
          'Ask questions to gather the necessary information. Provide relevant context with each question, and include any general context in the dedicated context section.',
      },
      {
