...
@injectable()
export class InformationNodeDao extends AbstractNodeDao<
  InformationNode,
  Prisma.InformationNodeCreateInput,
  Prisma.InformationNodeUpdateInput,
  Prisma.InformationNodeInclude
> {
  ...
  public async create(
    createInput: Prisma.InformationNodeCreateInput,
    includeClauses?: Prisma.InformationNodeInclude
  ): Promise<InformationNode> {
