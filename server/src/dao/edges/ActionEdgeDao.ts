...
@injectable()
export class ActionEdgeDao extends AbstractEdgeDao<ActionEdge, Prisma.ActionEdgeCreateInput, Prisma.ActionEdgeUpdateInput, Prisma.ActionEdgeInclude> {
  ...
  async create(createInput: Prisma.ActionEdgeCreateInput, includeClauses?: Prisma.ActionEdgeInclude): Promise<ActionEdge> {
