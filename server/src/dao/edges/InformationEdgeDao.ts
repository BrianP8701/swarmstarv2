...
@injectable()
export class InformationEdgeDao extends AbstractEdgeDao<
  InformationEdge,
  Prisma.InformationEdgeCreateInput,
  Prisma.InformationEdgeUpdateInput,
  Prisma.InformationEdgeInclude
> {
  ...
  public async create(
    createInput: Prisma.InformationEdgeCreateInput,
    includeClauses?: Prisma.InformationEdgeInclude
  ): Promise<InformationEdge> {
